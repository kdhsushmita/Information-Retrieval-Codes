...
news_data = [
    ("New study reveals benefits of meditation", "health"),
    ("Taylor Swift releases new single", "entertainment"),
    ("Government announces new environmental regulations", "politics"),
    ("New vaccine shows promising results in clinical trials", "health"),
    ("Upcoming film festival to showcase independent filmmakers", "entertainment"),
    ("Debate heats up over proposed tax reforms", "politics"),
    ("Exercise and diet tips for a healthier lifestyle", "health"),
    ("Popular TV series renewed for another season", "entertainment"),
    ("Legislature passes bill to improve public transportation", "politics"),
]
...
def main():
    # Test news articles
    test_articles = [
        "New study suggests benefits of outdoor exercise",
        "Taylor Swift announces surprise album release",
        "Government launches initiative to combat climate change"
    ]
